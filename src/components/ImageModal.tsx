            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden transform scale-100 transition-transform duration-300" onClick={(e) => e.stopPropagation()}> {/* stops the click from propogating to the backdrop */}
                ...
                <div className="overflow-y-scroll bg-gray-100 flex-grow max-h-[70vh] custom-scrollbar">
                    ...
                    <div className="p-8 bg-white border-t border-gray-300">
                        ...
                        <p className="text-gray-700 text-lg leading-relaxed whitespace-pre-line">{image.description}</p>
                    </div>

                    {/* link to site or github */}
                    <div className="p-2 bg-white">
                        <div className="pt-2 pb-15 text-gray-800 text-lg">
                            <a href={image.link} target="_blank" className="px-10 py-4 backdrop-blur-sm bg-blue-600 text-slate-800 rounded-full font-bold text-lg hover:bg-blue-300 transition-all hover:shadow-xl active:scale-95">Visit</a>
                        </div>
                    </div>
                </div>
